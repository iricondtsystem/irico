  ...
  `,name:t,type:0}}var dt,wh,al,sl,ul,ll,fl,cl,pl,dl,hl,ml,bl,gl,Tl,xl,Oh,Ih,Sh,wl,ro,Ol,Ah,Ph,Eh,Il,Dh,Lh,Fh,Sl,$h,yl=L(()=>{fe(),Vt(),xe(),ae(),dt=(e,t,r,n=t[0].type,o)=>{let i=2*!!e.session.pack;return{name:r.name,inputNames:["A","B"],inputTypes:[i,i],cacheHint:o,get:()=>wh(e,t,r,n)}},wh=(e,t,r,n=t[0].type)=>{let o=2*!!e.session.pack,i=!U.areEqual(t[0].dims,t[1].dims),s=t[0].dims,u=e.session.pack;if(i){let i=Xe.calcShape(t[0].dims,t[1].dims,!1);if(!i)throw Error("Can't perform binary op on the given tensors");let l=(s=i).length,c=0!==t[0].dims.length?t[0].dims.length:1,p=0!==t[1].dims.length?t[1].dims.length:1,d=0!==t[0].dims.length?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",f=0!==t[1].dims.length?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",h=q(e.session.backend.glContext.version),g=u?`
    ...
    `;return{name:r.name,inputNames:["A","B"],inputTypes:[o,o],output:{dims:t[0].dims,type:n,textureType:o},shaderSource:c,hasMain:!0}},al=(e,t)=>[e.run(dt(e,t,lh()),t)],sl=(e,t)=>[e.run(dt(e,t,bh(),"bool"),t)],ul=(e,t)=>[e.run(dt(e,t,fh()),t)],ll=(e,t)=>[e.run(dt(e,t,dh(),"bool"),t)],fl=(e,t)=>[e.run(dt(e,t,hh(),"bool"),t)],cl=(e,t)=>[e.run(dt(e,t,mh(),"bool"),t)],pl=(e,t)=>[e.run(dt(e,t,ch()),t)],dl=(e,t)=>[e.run(dt(e,t,gh(),"bool"),t)],hl=(e,t)=>[e.run(dt(e,t,Th()),t)],ml=(e,t)=>[e.run(dt(e,t,xh()),t)],bl=(e,t)=>[e.run(dt(e,t,ph()),t)],gl=(e,t)=>[e.run(dt(e,t,yh(),"bool"),t)]}),vl=L(()=>{fe(),Tl=(e,t,r)=>(Oh(t),[e.cast(t[0],r)]),xl=e=>Ve.tensorDataTypeFromProto(e.attributes.getInt("to")),Oh=e=>{if(!e||1!==e.length)throw Error("Cast requires 1 input.");if("string"===e[0].type)throw Error("Invalid input type.")}}),_l=L(()=>{xe(),ae(),Ft(),gr(),Ih=(e,t)=>({name:"Concat (packed)",inputNames:Array.from({length:e},(e,t)=>`X${t}`),inputTypes:Array(e).fill(2),cacheHint:t}),Sh=(e,t,r,n)=>{let o=r[0].dims.slice();if(n>=o.length||n<-1*o.length)throw Error("axis specified for concat doesn't match input dimensionality");n<0&&(n=o.length+n);let i=o.slice(0);for(let e=1;e<r.length;e++){let t=r[e].dims.slice();for(let e=0;e<o.length;e++)if(e===n)i[n]+=t[e];else if(o[e]!==t[e])throw Error("non concat dimensions must match")}let s=i.length,u=Nr("coords",s),l=Ke(s),c=$t(),p=r.map(e=>e.dims),d=St(s),f=Array(p.length-1);f[0]=p[0][n];for(let e=1;e<f.length;e++)f[e]=f[e-1]+p[e][n];let h=d[n],g=d.slice(-2),m=d.join(),b=`if (${h} < ${f[0]}) {
        return getChannel(
            ...
            return getChannel(
              getX${y}(${ro(d,h,v)}),
              vec2(${ro(g,h,v)}));`;let _=q(e.session.backend.glContext.version),x=`
          ${c}
...
`);let g="";g=l<2&&u>0?"coords":o.map((e,t)=>`coords.${h[t+d]}`).join(", ");let m="return outputValue;",b=1===U.size(o),y=1===U.size(i);if(1!==u||b||y){if(b&&!y)m=1===l?`
    ...
    `;return new R(_,["coordinates.getOutputCoords"])}getUnpackedSamplerAtOutputCoords(e,t,r,n){let o=[r.width,r.height],i=[t.width,t.height],s=t.unpackedShape.length,u=r.unpackedShape.length,l=t.unpackedShape,c=r.unpackedShape,p=Kn(n);if(s===u&&pr.arraysEqual(i,o)){let t=`
          float ${e}() {
